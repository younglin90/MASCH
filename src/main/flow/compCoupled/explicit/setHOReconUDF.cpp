		...
		calcHO_FaceVal.push_back(
            ...
            vector<vector<double>>& point_min)->int{
				...
				for(int ii=0; ii<2; ++ii){
                    ...
                    double dudxyz[3], dvdxyz[3], dwdxyz[3], dTdxyz[4];
					...
					if(ii==0){
                        ...
                        dTdxyz[0] = dTdxL; dTdxyz[1] = dTdyL; dTdxyz[2] = dTdzL;
                        ...
                        dTdxyz[0] = dTdxR; dTdxyz[1] = dTdyR; dTdxyz[2] = dTdzR;
					...
					for(int i=0; i<5; ++i) {
                        ...
                        if(boolLimiterMLP[i]==true){
                            ...
                            if(i==1){
                                ...
                                tmp_it1 = 4; tmp_it2 = 3;
                                // tmp_duvwdxyz[0] = dTdxyz[0];
                                // tmp_duvwdxyz[1] = dTdxyz[1];
                                // tmp_duvwdxyz[2] = dTdxyz[2];
