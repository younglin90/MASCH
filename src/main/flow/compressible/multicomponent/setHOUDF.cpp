...
void MASCH_Solver::setRecoFunctionsUDF(MASCH_Mesh& mesh, MASCH_Control& controls){
	...
	phiFL.push_back(controls.cellVar["left pressure"].id); 
	phiFR.push_back(controls.cellVar["right pressure"].id); 
	...
	phiFL.push_back(controls.cellVar["left x-velocity"].id); 
	phiFR.push_back(controls.cellVar["right x-velocity"].id);
	...
	phiFL.push_back(controls.cellVar["left y-velocity"].id); 
	phiFR.push_back(controls.cellVar["right y-velocity"].id);
	...
	phiFL.push_back(controls.cellVar["left z-velocity"].id); 
	phiFR.push_back(controls.cellVar["right z-velocity"].id);
	...
	phiFL.push_back(controls.cellVar["left temperature"].id); 
	phiFR.push_back(controls.cellVar["right temperature"].id); 
