...
void SEMO_Solvers_Builder::setIncomValuesLeftRightFaceWithReconPV(
	SEMO_Mesh_Builder& mesh,
	SEMO_Controls_Builder& controls,
	vector<SEMO_Species>& species){
...
void SEMO_Solvers_Builder::reconIncomZeroOrder(
	SEMO_Mesh_Builder& mesh,
	SEMO_Controls_Builder& controls,
	vector<SEMO_Species>& species){
	...
	for(auto& boundary : mesh.boundary){
		...
		if( boundary.type[controls.U] == "fixedValue" ){
			for(int i=str; i<end; ++i){
				...
				// //=================
				// // UDF
				// if(face.y <= 0.00096753){
					// face.varL[controls.fU] = 
						// (0.0 + (0.8233-0.0)/(0.00096753-0.0)*(face.y-0.0))*
						// boundary.var[controls.U];
					// face.varL[controls.fV] = 0.0;
					// face.varL[controls.fW] = 0.0;
				// }
				// else if(face.y > 0.00096753 && face.y <= 0.00197377){
					
					// face.varL[controls.fU] = 
						// (0.8233 + (0.9422-0.8233)/(0.00197377-0.00096753)*(face.y-0.00096753))*
						// boundary.var[controls.U];
					// face.varL[controls.fV] = 0.0;
					// face.varL[controls.fW] = 0.0;
					
				// }
				// else if(face.y > 0.00197377 && face.y <= 0.0029542){
					// face.varL[controls.fU] = 
						// (0.9422 + (0.9924-0.9422)/(0.0029542-0.00197377)*(face.y-0.00197377))*
						// boundary.var[controls.U];
					// face.varL[controls.fV] = 0.0;
					// face.varL[controls.fW] = 0.0;
					
				// }
				// else if(face.y > 0.0029542 && face.y <= 0.00396044){
					// face.varL[controls.fU] = 
						// (0.9924 + (1.0-0.9924)/(0.00396044-0.0029542)*(face.y-0.0029542))*
						// boundary.var[controls.U];
					// face.varL[controls.fV] = 0.0;
					// face.varL[controls.fW] = 0.0;
					
				// }
				// else if(face.y > 0.00396044 ){
					// face.varL[controls.fU] = 1.0*boundary.var[controls.U];
					// face.varL[controls.fV] = 0.0;
					// face.varL[controls.fW] = 0.0;
