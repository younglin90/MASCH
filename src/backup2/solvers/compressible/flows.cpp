...
double SEMO_Solvers_Builder::calcCompFlowsEq(
	...
	// for(int i=0; i<mesh.cells.size(); ++i){
        ...
        // A_vals[id] = cTime * ( Rho * U )*volume/timeStep -
					 // Rho*(controls.gravityAcceleration[0])*volume;
        ...
        // A_vals[id] = cTime * ( Rho * V )*volume/timeStep -
					 // Rho*(controls.gravityAcceleration[1])*volume;
        ...
        // A_vals[id] = cTime * ( Rho * W )*volume/timeStep -
					 // Rho*(controls.gravityAcceleration[2])*volume;
	...
	// for(int i=0; i<mesh.faces.size(); ++i){
		...
		// A_vals[id] += ( RhoF * WUL * nvec[0] * UF * area + weightL * RhoL * UnF * area + 
						// 0.5*Mdash*PLP*PRM*0.5/Cbar*nvec[0] * nvec[0] * area + 
						// diff_viscous * area );
		// A_rows.push_back(i_glo); A_cols.push_back(j_glo);
		// A_vals.push_back(( RhoF * WUR * nvec[0] * UF * area + weightR * RhoR * UnF * area - 
						// 0.5*Mdash*PLP*PRM*0.5/Cbar*nvec[0] * nvec[0] * area -
						// diff_viscous * area ));
		...
		// if(face.getType() == SEMO_Types::INTERNAL_FACE) {
			...
			// A_vals[id] -= ( RhoF * WUR * nvec[0] * UF * area + weightR * RhoR * UnF * area - 
						// 0.5*Mdash*PLP*PRM*0.5/Cbar*nvec[0] * nvec[0] * area -
						// diff_viscous * area );
			// A_rows.push_back(i_glo); A_cols.push_back(j_glo);
			// A_vals.push_back(-( RhoF * WUL * nvec[0] * UF * area + weightL * RhoL * UnF * area + 
						// 0.5*Mdash*PLP*PRM*0.5/Cbar*nvec[0] * nvec[0] * area +
						// diff_viscous * area ));
		...
		// A_vals[id] += ( RhoF * WUL * nvec[1] * UF * area +
						// 0.5*Mdash*PLP*PRM*0.5/Cbar*nvec[1] * nvec[0] * area
						// );
		// A_rows.push_back(i_glo); A_cols.push_back(j_glo);
		...
		// A_vals[id] += ( RhoF * WUL * nvec[2] * UF * area +
						// 0.5*Mdash*PLP*PRM*0.5/Cbar*nvec[2] * nvec[0] * area
						// );
		// A_rows.push_back(i_glo); A_cols.push_back(j_glo);
		...
		// A_vals[id] += ( RhoF * WUL * nvec[0] * VF * area +
						// 0.5*Mdash*PLP*PRM*0.5/Cbar*nvec[0] * nvec[1] * area
						// );
		// A_rows.push_back(i_glo); A_cols.push_back(j_glo);
		...
		// A_vals[id] += ( RhoF * WUL * nvec[1] * VF * area + weightL * RhoL * UnF * area + diff_viscous * area +
						// 0.5*Mdash*PLP*PRM*0.5/Cbar*nvec[1] * nvec[1] * area
						// );
		// A_rows.push_back(i_glo); A_cols.push_back(j_glo);
		// A_vals.push_back(( RhoF * WUR * nvec[1] * VF * area + weightR * RhoR * UnF * area - diff_viscous * area -
						// 0.5*Mdash*PLP*PRM*0.5/Cbar*nvec[1] * nvec[1] * area
						// ));
		...
		// if(face.getType() == SEMO_Types::INTERNAL_FACE) {
			...
			// A_vals[id] -= ( RhoF * WUR * nvec[1] * VF * area + weightR * RhoR * UnF * area - diff_viscous * area -
						// 0.5*Mdash*PLP*PRM*0.5/Cbar*nvec[1] * nvec[1] * area
						// );
			// A_rows.push_back(i_glo); A_cols.push_back(j_glo);
			// A_vals.push_back(-( RhoF * WUL * nvec[1] * VF * area + weightL * RhoL * UnF * area + diff_viscous * area +
						// 0.5*Mdash*PLP*PRM*0.5/Cbar*nvec[1] * nvec[1] * area
						// ));
		...
		// A_vals[id] += ( RhoF * WUL * nvec[2] * VF * area +
						// 0.5*Mdash*PLP*PRM*0.5/Cbar*nvec[2] * nvec[1] * area
						// );
		// A_rows.push_back(i_glo); A_cols.push_back(j_glo);
		...
		// A_vals[id] += ( RhoF * WUL * nvec[0] * WF * area +
						// 0.5*Mdash*PLP*PRM*0.5/Cbar*nvec[0] * nvec[2] * area
						// );
		// A_rows.push_back(i_glo); A_cols.push_back(j_glo);
		...
		// A_vals[id] += ( RhoF * WUL * nvec[1] * WF * area +
						// 0.5*Mdash*PLP*PRM*0.5/Cbar*nvec[1] * nvec[2] * area
						// );
		// A_rows.push_back(i_glo); A_cols.push_back(j_glo);
		...
		// A_vals[id] += ( RhoF * WUL * nvec[2] * WF * area + weightL * RhoL * UnF * area + diff_viscous * area +
						// 0.5*Mdash*PLP*PRM*0.5/Cbar*nvec[2] * nvec[2] * area
						// );
		// A_rows.push_back(i_glo); A_cols.push_back(j_glo);
		// A_vals.push_back(( RhoF * WUR * nvec[2] * WF * area + weightR * RhoR * UnF * area - diff_viscous * area -
						// 0.5*Mdash*PLP*PRM*0.5/Cbar*nvec[2] * nvec[2] * area
						// ));
		...
		// if(face.getType() == SEMO_Types::INTERNAL_FACE) {
			...
			// A_vals[id] -= ( RhoF * WUR * nvec[2] * WF * area + weightR * RhoR * UnF * area - diff_viscous * area -
						// 0.5*Mdash*PLP*PRM*0.5/Cbar*nvec[2] * nvec[2] * area
						// );
			// A_rows.push_back(i_glo); A_cols.push_back(j_glo);
			// A_vals.push_back(-( RhoF * WUL * nvec[2] * WF * area + weightL * RhoL * UnF * area + diff_viscous * area +
						// 0.5*Mdash*PLP*PRM*0.5/Cbar*nvec[2] * nvec[2] * area
						// ));
		...
		// vector<double> convective_flux(5,0.0);
	...
	// for(auto& boundary : mesh.boundary){
		...
		// if(boundary.neighbProcNo == -1){
			...
			// for(int i=str; i<end; ++i){
				...
				// vector<double> viscous_flux(5,0.0);
				// viscous_flux[1] = muF * (txx*nvec[0] + txy*nvec[1] + txz*nvec[2] + dUdnF) * area;
				// // flux[1] -= nx * 2.0/3.0 * rhoF * tkei;
				// viscous_flux[2] = muF * (tyx*nvec[0] + tyy*nvec[1] + tyz*nvec[2] + dVdnF) * area;
				// // flux[2] -= ny * 2.0/3.0 * rhoF * tkei;
				...
				// A_vals[id] += coeffP_diff * ( RhoF * tmp1 / dPN * UF * area );
				...
				// A_vals[id] += coeffP_diff * ( RhoF * tmp1 / dPN * VF * area );
				...
				// A_vals[id] += coeffP_diff * ( RhoF * tmp1 / dPN * WF * area );
				...
				// A_vals[id] += coeffP_diff * ( RhoF * tmp1 / dPN * dHtDPF * area );
