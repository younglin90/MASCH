...
// void MASCH_Controls::readSpecies(vector<SEMO_Species>& species){
...
// void MASCH_Controls::readConfigures(){
...
// void MASCH_Controls::setValues(vector<SEMO_Species>& species){
